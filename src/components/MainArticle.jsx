    ...
    <section className='mb-12 md:mb-0'>
      ...
      <div className='sm:flex'>
        ...
        <div className='flex-1 pt-9 px-4'>
          <p className='text-[13px] mb-10 sm:text-[15px]'>We dive into the next evolution of the web that claims to put the power of the platform back into the hands of the people. But is it really fulfilling its promise?</p>
